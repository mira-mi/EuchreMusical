...
card cardChecker::winningCard() {
    ...
    //bower a
    //i have no idea what I was writing here but I guess I was going to say something about what a bower was.
    //high trump cards essentially, so yeah
    ...
    if (hasTrump()) {
        //if has, check highest card of trump suits
        for (int i = 0; i < bench.size(); i++) {
